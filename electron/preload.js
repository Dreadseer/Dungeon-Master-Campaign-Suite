...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  db: {
    ...
    sessions: {
      ...
      getCurrent:  (campaignId)  => ipcRenderer.invoke('db:sessions:getCurrent', campaignId),
      create:      (data)        => ipcRenderer.invoke('db:sessions:create', data),
      update:      (id, data)    => ipcRenderer.invoke('db:sessions:update', id, data),
      updateNotes: (id, notes)   => ipcRenderer.invoke('db:sessions:updateNotes', id, notes),
      delete:      (id)          => ipcRenderer.invoke('db:sessions:delete', id),
    },
    plots: {
      getAll:       (campaignId)               => ipcRenderer.invoke('db:plots:getAll', campaignId),
      getById:      (id)                       => ipcRenderer.invoke('db:plots:getById', id),
      create:       (data)                     => ipcRenderer.invoke('db:plots:create', data),
      update:       (id, data)                 => ipcRenderer.invoke('db:plots:update', id, data),
      updateStatus: (id, status, sessionId)    => ipcRenderer.invoke('db:plots:updateStatus', id, status, sessionId),
      delete:       (id)                       => ipcRenderer.invoke('db:plots:delete', id),
    },
    reveals: {
      getForCampaign: (campaignId)                            => ipcRenderer.invoke('db:reveals:getForCampaign', campaignId),
      getForSession:  (sessionId)                             => ipcRenderer.invoke('db:reveals:getForSession', sessionId),
      isRevealed:     (entityType, entityId)                  => ipcRenderer.invoke('db:reveals:isRevealed', entityType, entityId),
      reveal:         (campaignId, entityType, entityId, sessionId) => ipcRenderer.invoke('db:reveals:reveal', campaignId, entityType, entityId, sessionId),
      unreveal:       (entityType, entityId)                  => ipcRenderer.invoke('db:reveals:unreveal', entityType, entityId),
    },
    factions: {
    ...
    maps: {
      ...
      getByLocation:  (locationId)    => ipcRenderer.invoke('db:maps:getByLocation', locationId),
    ...
    encounters: {
      ...
      getByLocation:  (locationId)            => ipcRenderer.invoke('db:encounters:getByLocation', locationId),
